...
/*   Updated: 2023/01/13 14:08:49 by isel-jao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
						...
						<< "\033[0m" << std::endl;
	{
		...
		try
		{
			...
			if (s3 == s4)
				std::cout << "s3 and s4 are equal\n";
			if (s3 != s4)
				std::cout << "s3 and s4 are not equal\n";
			if (s3 < s4)
				std::cout << "s3 is less than s4\n";
			if (s3 > s4)
				std::cout << "s3 is greater than s4\n";
			if (s3 <= s4)
				std::cout << "s3 is less than or equal to s4\n";
			if (s3 >= s4)
