...
/*   Updated: 2023/01/13 13:56:44 by isel-jao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
						...
						<< "\033[0m" << std::endl;
	{
		...
		try
		{
			...
			std::cout << "insert a : "
								<< "[ " << p.first->first << " , " << p.first->second << " ] | Added : " << p.second << std::endl;
			p = m1.insert(std::make_pair("a", 1));
			std::cout << "insert a : "
								<< "[ " << p.first->first << " , " << p.first->second << " ] | Added : " << p.second << std::endl;
			std::cout << "m1 size : " << m1.size() << std::endl;
	...
	std::cout << std::endl
						<< "\033[36m"
						<< "************************************ test 9 < lower_bound , upper_bound , equal_range > ************************************ "
						<< "\033[0m" << std::endl;
	{
		std::cout << "\033[32m"
							<< "----------------------- ORIGINAL -----------------------"
